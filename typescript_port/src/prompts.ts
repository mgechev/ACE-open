...
export const GENERATOR_PROMPT = `You are an expert assistant that must solve the task using the provided playbook of strategies.
...
export const CURATOR_PROMPT = `You are the curator of the ACE playbook. Merge the latest reflection into structured updates.
